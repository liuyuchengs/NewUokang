app.controller("examDetailCtrl",["$scope","$http","$location","Tool",function($scope,$http,$location,Tool){
	$scope.loading = false;
	...
	*/
	$scope.loadSchedule = function(){
		var url = Tool.getSession("host")+"/wx/schedule/querybyhospitalid";
	...
	*/
	$scope.loadProduct = function(){
		var url = Tool.getSession("host")+"/wx/product/packagedetal";
	...
	*/
	$scope.loadProductItem = function(){
		var url = Tool.getSession("host")+"/wx/product/packagedetalItem";
		var params = "packageid="+$scope.productId;
		$http.post(url,params,{
			headers:{
				'Content-type':'application/x-www-form-urlencoded;charset=UTF-8',
	...
	*/
	$scope.loadHospital = function(){
		var url = Tool.getSession("host")+"/wx/product/hospitalbyid";
	...
	*/
	$scope.loadHopitalImg = function(){
		var url = Tool.getSession("host")+"/wx/image/querybymainid";
