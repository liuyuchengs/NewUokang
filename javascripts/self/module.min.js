		...
		wx.ready(function(){
			wx.getLocation({
				...
				success:function(res){
					scope.locationInfo.latitude = res.latitude;
					scope.locationInfo.longitude = res.longitude;
				}
			});
			wx.checkJsApi({
				//需要检测的JS接口列表
...
app.service("Params",[function(){
	...
	this.professionalParams = {
		yake:{has:false,val:this.yakeParams},
		meirong:{has:false,val:this.meirongParams},
		fck:{has:false,val:this.fckParams},
		zhongyi:{has:false,val:this.zhongyiParams},
		tijian:{has:false,val:this.tijianParams}
	}
}])
