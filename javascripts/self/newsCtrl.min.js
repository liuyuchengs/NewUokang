app.controller("newsCtrl",["$scope","$http","Tool",function($scope,$http,Tool){
	$scope.news = [];
	$scope.navValue = "all";
	$scope.currentPage = 1;
	$scope.pageRows = 10;
...
app.controller("newsDetailCtrl",["$scope","$http","$location","Tool",function($scope,$http,$location,Tool){
	$scope.loading= false;
	$scope.detail = {};
	$scope.id = null;
	...
	$scope.loadDetail = function(){
		$scope.loading = true;
		var url = Tool.getSession("host")+"/wx/health/querydetail";
